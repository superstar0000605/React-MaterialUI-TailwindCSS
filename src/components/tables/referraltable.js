...
// project import
function createData(website, sessions, avgTime) {
    return { website, sessions, avgTime };
}

const rows = [
    createData('www.goodread.com', 127, '05:17 min'),
    createData('www.tumblr.com', 2347, '15:18 min'),
    createData('www.annesarchive.com', 79, '02:32 min'),
    createData('www.pinterest.com', 1272, '12:32 min')
];
